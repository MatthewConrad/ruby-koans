...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When it fails to find any occurence of the pattern, it will return nil
  end
  ...
  # The * is used to match and return as many possible characters from the input -- will grab as much data as it can 
