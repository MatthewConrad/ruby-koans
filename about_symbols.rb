...
class AboutSymbols < Neo::Koan
  ...
  # symbols refer to an object, so the equality check is looking at the object id, not the content
  # strings will correctly compare content
  ...
  # symbols are kept in memory (that's the whole point), so dynamically creating a bunch that you're not going to use is a waste
end
