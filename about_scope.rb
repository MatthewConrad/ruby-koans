...
class AboutScope < Neo::Koan
  ...
  def test_dog_is_not_available_in_the_current_scope
    assert_raise(NameError) do
      Dog.new # Dog is not defined outside of any modules, so trying to call it by itself raises a NameError
    end
  end
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    assert_equal [:Dog], Jims.constants # class names count as constants!
